...
class PDFViajesNetos extends Rotation
{
     ...
     * @param string $unit
     * @param string $size
     * @param array $viajes_netos
     */
    public function __construct($orientation = 'P', $unit = 'cm', $size = 'A4', Array $viajes_netos)
    {
        parent::__construct($orientation, $unit, $size);

        $this->SetAutoPageBreak(true, 1.5);
        $this->viajes_netos = $viajes_netos;
    ...
    private function title()
    {
        ...
        $this->CellFitScale(0.6 * $this->WidthTotal, 1.5, utf8_decode('VIAJES NETOS'), 0, 1, 'L', 0);
        ...
        //Detalles (Titulo)
        $this->SetFont('Arial', 'B', $this->txtSeccionTam);
        $this->Cell(0.45 * $this->WidthTotal, 0.7, utf8_decode('Detalles de la Consulta'), 0, 0, 'L');
    }
